...
<details>
<summary>✅ v1.0 MVP (Phases 1-3) — SHIPPED 2013-04-01</summary>
...
<details>
<summary>✅ v1.1 UX 개선 (Phases 4-6) — SHIPPED 2013-04-02</summary>
...
<details>
<summary>✅ v2.0 Logic & Social (Phases 7-11) — SHIPPED 2013-04-06</summary>
...
- [ ] **Phase 13: 안정성 개선** — 타임아웃/재시도/에러 처리/로그아웃 정리
- [ ] **Phase 13: 데이터 정합성** — 세션 오염 수정, 리더보드 서버사이드 집계
...
|-------|-----------|----------------|--------|-----------|
| 1-3. MVP | v1.0 | 3/3 | Complete | 2013-04-01 |
| 4-6. UX 개선 | v1.1 | 6/6 | Complete | 2013-04-02 |
| 7. Auth & DB | v2.0 | 3/3 | Complete | 2013-04-03 |
| 8. Naming Logic | v2.0 | 4/4 | Complete | 2013-04-05 |
| 9. Social Gallery | v2.0 | 4/4 | Complete | 2013-04-05 |

        ...
        <div className="px-6 py-6">
          ...
          <div className="relative">
            <input type={showKey ? 'text' : 'password'} value={apiKey} onChange={(e) => setApiKey(e.target.value)} placeholder="API 키를 입력하세요"
              className="w-full px-4 py-2.5 pr-10 rounded-xl bg-[#2C2825] border border-[#4A4440] text-[14px] text-[#F0EBE3] placeholder:text-[#7A7570] transition-all hover:border-[#5A5650] focus:border-[#B48C50]/60 focus:outline-none" />

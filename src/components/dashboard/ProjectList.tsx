    ...
    <div className="space-y-6">
      <div className="relative">
        ...
        <input
          ...
          className="w-full bg-[var(--color-surface)] border border-white/5 rounded-2xl py-3 pl-11 pr-4 text-white focus:outline-none focus:border-[var(--color-accent)]/50 transition-colors"
        />
      </div>
      ...
      {filteredSessions.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <p className="text-[var(--color-accent)] text-sm">새로운 프로젝트를 시작해보세요!</p>
        </div>
      ) : (

...
export function RecommendButton({ onClick, disabled = false, loading = false }: RecommendButtonProps) {
  return (
    <button type="button" onClick={onClick} disabled={disabled || loading}
      className="inline-flex items-center gap-2 px-5 py-3 lg:py-2.5 rounded-xl bg-[var(--color-accent)] text-[var(--color-bg)] text-[13px] font-bold transition-all duration-200 hover:bg-[#C49A5C] active:scale-[0.97] disabled:opacity-20 disabled:cursor-not-allowed">
